...
# -*- coding: utf-8 -*-
#
# scikit-surgerysurfacematch documentation build configuration file, created by
...
# This allows modules to be indexed under the submodule name rather than all appearing under sksurgerysurfacematch
modindex_common_prefix = [
    'sksurgerysurfacematch.'
]

# General information about the project.
project = u'scikit-surgerysurfacematch'
...
# The short X.Y version.
# version = sksurgerysurfacematch.__version__
# The full version, including alpha/beta/rc tags.
# release = sksurgerysurfacematch.__version__
...
htmlhelp_basename = 'scikit-surgerysurfacematchdoc'
...
latex_documents = [
    ('index', 'scikit-surgerysurfacematch.tex',
     u'scikit-surgerysurfacematch Documentation',
...
man_pages = [
    ('index', 'scikit-surgerysurfacematch',
     u'scikit-surgerysurfacematch Documentation',
     [u'Matt Clarkson'], 1)
]
