...
This is the software requirements file for scikit-surgerysurfacematch, part of the
SNAPPY project. The requirements listed below should define
what scikit-surgerysurfacematch does. Each requirement can be matched to a unit test that
